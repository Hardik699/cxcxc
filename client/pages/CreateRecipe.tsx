  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setTimeout(() => {
          if (id) {
            // If editing, redirect to recipe detail page
            navigate(`/recipe/${id}`);
          } else {
            // If creating new, redirect to list
            navigate("/rmc");
          }
        }, 1500);
      } else {
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                ...
                <CostingCalculatorForm
                  ...
                  hideSaveButton={true}
                  onLabourCostChange={(prodCost, packCost) => {
                    setProductionLabourCostPerKg(prodCost);
                    setPackingLabourCostPerKg(packCost);
                  }}
                />
              </div>
            </div>
