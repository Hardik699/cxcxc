                ...
                <div className="flex gap-2">
                  <Button
                    onClick={() => {
                      ...
                      console.log("🔍 Selected entries:", selectedEntriesForComparison);
                      console.log("🔍 First entry packaging costs:", selectedEntriesForComparison[0]?.packagingCosts);
                      console.log("🔍 Second entry packaging costs:", selectedEntriesForComparison[1]?.packagingCosts);
                      console.log("🔍 First entry labour costs:", {
                        production: selectedEntriesForComparison[0]?.productionLabourCostPerKg,
                        packing: selectedEntriesForComparison[0]?.packingLabourCostPerKg
                      });
                      console.log("🔍 Second entry labour costs:", {
                        production: selectedEntriesForComparison[1]?.productionLabourCostPerKg,
                        packing: selectedEntriesForComparison[1]?.packingLabourCostPerKg
                      });
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-200 dark:border-amber-800 rounded-lg p-4">
                        <h3 className="text-base font-bold text-amber-900 dark:text-amber-100 mb-3">
                          OLD Recipe
                        </h3>
                        <div className="space-y-2 text-xs">
                          ...
                          <div className="pt-2 border-t-2 border-amber-300 dark:border-amber-700 mt-3">
                      ...
                      <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-xs">
                          ...
                          <div className="pt-2 border-t-2 border-blue-300 dark:border-blue-700 mt-3">
                            <p className="font-bold text-blue-900 dark:text-blue-100">
                      ...
                      <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 rounded-lg p-4">
                        <h3 className="text-base font-bold text-red-900 dark:text-red-100 mb-3">
                          DIFFERENCES
                        </h3>
                        {changes.length === 0 ? (
                    ...
                    <div className="bg-purple-50 dark:bg-purple-900/20 border-2 border-purple-200 dark:border-purple-800 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {/* OLD Labour Costs */}
                        <div>
                          <h4 className="text-sm font-bold text-amber-900 dark:text-amber-100 mb-3">OLD</h4>
                          <div className="space-y-2 text-xs">
                            ...
                            <table className="w-full text-xs">
                              <thead>
                                <tr className="border-b-2 border-green-300 dark:border-green-700">
                                  <th className="text-left p-2 font-bold text-green-900 dark:text-green-100">Cost Component</th>
                                  <th className="text-right p-2 font-bold text-amber-900 dark:text-amber-100">OLD (₹/Kg)</th>
                                  <th className="text-right p-2 font-bold text-blue-900 dark:text-blue-100">NEW (₹/Kg)</th>
                                  <th className="text-right p-2 font-bold text-red-900 dark:text-red-100">CHANGE</th>
                                </tr>
                              </thead>
                              <tbody>
                                {costItems.map((item) => {
                                ...
                                <tr className="bg-green-100 dark:bg-green-900/30 border-t-2 border-green-300 dark:border-green-700 font-bold">
                                  <td className="p-2 text-green-900 dark:text-green-100">TOTAL PACKAGING & HANDLING COST / KG</td>
                                  <td className="p-2 text-right text-amber-900 dark:text-amber-100">
